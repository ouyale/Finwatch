...
class CustomerRecord(BaseModel):
    ...
    EXT_SOURCE_1:        Optional[float] = Field(None, description="External credit score 1 (may be missing)")
    EXT_SOURCE_2:        Optional[float] = Field(None, description="External credit score 2 (may be missing)")
    EXT_SOURCE_3:        Optional[float] = Field(None, description="External credit score 3 (may be missing)")
